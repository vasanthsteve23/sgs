...
<select name="complaintype" class="form-control" required="">
                ...
                <option value=" Complaint"> A</option>
                  <option value="General Query">B</option>
                  <option value="General Query">C</option>
                </select>
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Subject of the Complaint</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Related Doc <br><br><b>(compulsorily upload the class representaive or class tutor signature)<b></label>
<div class="col-sm-6">
